...
class Gradi_Adsence extends Module implements WidgetInterface
{
    private $templateFile;

	public function __construct()
	{
		$this->name = 'Gradi_Adsence';
		$this->version = '2.1.0';
		$this->author = 'JuanVegaDV';
		$this->need_instance = 1;

        $this->bootstrap = true;
        parent::__construct();

        $this->displayName = $this->trans('Gradi_Adsence', array(), 'Modules.Banner.Admin');
        $this->description = $this->trans('Por la pandemia del covid 19 nuestro cliente a perdido muchas ventas por lo cual decidió agregar un banner publicitario en el sitio web.', array(), 'Modules.Banner.Admin');
        $this->confirmUninstall = $this->l('¿Estas seguro que deseas desinstalar mi modulo?');

        $this->ps_versions_compliancy = array('min' => '1.7.1.0', 'max' => _PS_VERSION_);

        $this->templateFile = 'module:Gradi_Adsence/Gradi_Adsence.tpl';
    }
    ...
    protected function installFixtures()
    {
        ...
        foreach ($languages as $lang) {
            $this->installFixture((int)$lang['id_lang'], 'sale60.jpg');
        }
    ...
    public function uninstall()
    {
        ...
        Configuration::deleteByName('BANNER_TITLE');
        Configuration::deleteByName('BANNER_DESC');
        Configuration::deleteByName('BANNER_LINK');
        Configuration::deleteByName('BANNER_LABEL');
    ...
    public function postProcess()
    {
        if (Tools::isSubmit('submitStoreConf')) {
            ...
            foreach ($languages as $lang) {
                ...
                $values['BANNER_TITLE'][$lang['id_lang']] = Tools::getValue('BANNER_TITLE_'.$lang['id_lang']);
                ...
                $values['BANNER_LABEL'][$lang['id_lang']] = Tools::getValue('BANNER_LABEL_'.$lang['id_lang']);
            }
            ...
            'form' => array(
                ...
                'input' => array(
                    ...
                    array(
                        ...
                        'name' => 'BANNER_TITLE',
                        'desc' => $this->trans('Please enter a title for the banner.', array(), 'Modules.Banner.Admin')
                    ),
                    array(
                        'type' => 'text',
                        'lang' => true,
                    ...
                    array(
                        'type' => 'text',
                        'lang' => true,
                        'label' => $this->trans('Banner label', array(), 'Modules.Banner.Admin'),
                        'name' => 'BANNER_LABEL',
                        'desc' => $this->trans('Please enter a short label for the banner.', array(), 'Modules.Banner.Admin')
                    )
                ),
                'submit' => array(
    ...
    public function getConfigFieldsValues()
    {
        ...
        foreach ($languages as $lang) {
            ...
            $fields['BANNER_TITLE'][$lang['id_lang']] = Tools::getValue('BANNER_TITLE_'.$lang['id_lang'], Configuration::get('BANNER_TITLE', $lang['id_lang']));
            ...
            $fields['BANNER_LABEL'][$lang['id_lang']] = Tools::getValue('BANNER_LABEL_'.$lang['id_lang'], Configuration::get('BANNER_LABEL', $lang['id_lang']));
        }
    ...
    {
        if (!$this->isCached($this->templateFile, $this->getCacheId('Gradi_Adsence'))) {
            $this->smarty->assign($this->getWidgetVariables($hookName, $params));
        }

        return $this->fetch($this->templateFile, $this->getCacheId('Gradi_Adsence'));
    }
    ...
    public function getWidgetVariables($hookName, array $params)
    {
        ...
        if (!$banner_link) {
            $banner_link = $this->context->link->getPageLink('https://');
        }

        return array(
            'banner_title' => Configuration::get('BANNER_TITLE', $this->context->language->id)
            'banner_link' => $this->updateUrl($banner_link),
            'banner_desc' => Configuration::get('BANNER_DESC', $this->context->language->id)
            'banner_label' => Configuration::get('BANNER_LABEL', $this->context->language->id)
        );
    }
